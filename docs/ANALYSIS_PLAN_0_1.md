...
- 84 fragmentos de reserva para la primera ronda formal de confiabilidad, definidos como el complemento exacto de esos 12 dentro de los 96 fragmentos congelados.
...
Una vez construido un gold set válido, se permitirán únicamente análisis compatibles con la cobertura del corpus:

- distribución de actos pedagógicos dentro del piloto;
- distribución de dimensiones pedagógicas;
- modos de normatividad/evidencia;
- actor y destinatario de la acción pedagógica;
- cruces descriptivos por era analítica, tipo documental y procedencia cuando el número de casos sea suficiente;
- contraste entre discurso prescriptivo, política normativa, práctica reportada, testimonio y observación cuando exista soporte empírico suficiente.
...
Cuando exista validación humana, la canalización reproducible deberá producir como mínimo:

1. resumen de completitud y problemas de acceso;
2. tabla de acuerdo por campo;
3. medidas de confiabilidad definidas por el protocolo;
4. matriz de desacuerdos para revisión;
5. gold set adjudicado con provenance;
6. tablas descriptivas del corpus validado;
7. un reporte machine-readable y otro legible por humanos.
