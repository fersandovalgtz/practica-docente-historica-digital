...
| Slots con localizador candidato/resuelto | **86 / 96** |
| Fragmentos completamente congelados | **65 / 96** |
...
La cola de trabajo está organizada en shards auditables `data/samples/fragment_locator_progress*.csv`. En el corte actual su unión contiene **86/96** slots con una página o sección candidata, resuelta o congelada. Los fragmentos que ya cruzaron el gate completo se registran en `data/samples/frozen_fragments*.csv`; su unión contiene **65/96** fragmentos.
